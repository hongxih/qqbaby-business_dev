define(function (require, exports, module) {
    ...
    // var type = 1;
    var vm = new Vue({
        el: '#managerScreenItem',
        template: _g.getTemplate('manager/managerScreenItem-body-V'),
        data: {
            type:type,
            list:[
                {
    ...
    var getData = function(opts,callback){
        ...
        Http.ajax({
            ...
            success: function(res) {
                logger.log({"Type":"operation","action":"店长提成品牌分类筛选","Win_name":api.winName,"data":_data,"message":res,"requireURL":_url})
                if (res.code == 200) {
                    setTimeout(function(){
