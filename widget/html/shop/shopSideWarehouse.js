define(function (require, exports, module) {
    ...
    var vm = new Vue({
        el: '#shopSideWarehouse',
        template: _g.getTemplate('shop/shopSideWarehouse-body-V'),
        data: {
            isAllChecked:false,
            list: [
                {
    ...
    var getData = function () {
        ...
        Http.ajax({
            ...
            success: function (res) {
                logger.log({"Type":"operation","action":"门店管理-侧边栏-仓库数据获取","Win_name":api.winName,"message":res,"requireURL":_url})
